...
class AddonController extends BaseController {
    ...
    public function permission_callback_admin_only() {
    ...
    /**
     * Keep Addons REST list aligned with active YayMail Woo vs Email Builder Pro (same idea as addons_platform in localize).
     *
