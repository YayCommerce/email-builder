                        ...
                        Column::get_object_data(
                            ...
                            [
                                'children' => [
                                    ...
                                    Text::get_object_data(
                                        [
                                            'rich_text'  => '<p style="display: flex; justify-content: center; font-size: 14px; margin: 0px;"><u>Explore Now</u> <span style="padding: 1px 0px 0px 5px;"> <img src="#" style="width:20px !important; height:20px !important;" alt="arrow banner 3" width="12" height="12" /> </span></p>',
                                            'background_color' => '#ffffff00',
                                            'text_color' => '#333439',
                                            'padding'    => [
                                                'top'    => 10,
