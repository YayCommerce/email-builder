                        ...
                        Column::get_object_data(
                            ...
                            [
                                'children' => [
                                    ...
                                    Text::get_object_data(
                                        [
                                            'rich_text'  => '<p style="font-size: 14px; text-align: center; margin: 0px;"><span style="font-size: 16px;"><span style="text-decoration: underline;">Explore Now</span> <img src="#" style="width:20px !important; height:20px !important;" alt="" width="12" height="12" /></span></p>',
                                            'background_color' => '#ffffff00',
                                            'text_color' => '#333439',
                                            'padding'    => [
                                                'top'    => 0,
