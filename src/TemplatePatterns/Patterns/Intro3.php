                                ...
                                'children' => [
                                    ...
                                    Text::get_object_data(
                                        [
                                            'background_color' => '#ffffff00',
                                            'text_color' => '#FFFFFF',
                                            'rich_text'  => '<p><a style="text-decoration: underline; font-size: 15px; font-weight: 500; color: #333439 !important; text-underline-offset: 4px;" href="[yaymail_site_url]">Shop Now <img style="margin-left: 3px; width: 12px;" src="#" alt="arrow_right" /></a></p>',
                                            'padding'    => [
                                                'top'    => 25,
                                                'bottom' => 25,
                                                'right'  => 0,
