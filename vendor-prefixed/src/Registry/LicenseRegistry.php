...
namespace EmailBuilderScoped\YayCommerce\AdminShell\Registry;
...
class LicenseRegistry
{
    ...
    public function all(): array
    {
        ...
        $old_plugins = [];
        $handlers = ['EmailBuilderScoped\YAYDP\License\License_Handler', 'EmailBuilderScoped\YayMail\License\LicenseHandler', 'EmailBuilderScoped\Yay_Currency\License\LicenseHandler', 'EmailBuilderScoped\Yay_Swatches\License\LicenseHandler', 'EmailBuilderScoped\YayExtra\License\LicenseHandler', 'EmailBuilderScoped\YayRev\License\LicenseHandler', 'EmailBuilderScoped\YayWholesaleB2B\License\LicenseHandler', 'EmailBuilderScoped\YaySMTP\License\LicenseHandler'];
